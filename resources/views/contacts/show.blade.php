              ...
              <div class="flex flex-wrap -m-2">
                ...
                <div class="p-2 w-full">
                  ...
                  <div class="p-2 w-full -ml-2">
                    ...
                    <div class="p-2 w-full -ml-1">
                      <div class="relative">
                        <label for="url" class="leading-7 text-sm text-gray-600">ホームページ</label>
                        @if ($contact->url)
                          <div
                            class="w-ful rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            {{ $contact->url }}
                          </div>
                        @endif
                      </div>
                      <div class="p-2 w-full -ml-3">
                        <div class="relative">
